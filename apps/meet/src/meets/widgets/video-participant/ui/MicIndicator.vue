<template>
  ...
  >
    ...
    <Indicator
      :trigger="showTriggerStyle"
      :variant="isAudioEnabled ? 'success' : 'danger'"
      class="volume-indicator-wrap__indicator"
      :title="title"
      aria-label="Микрофон"
...
import { PixelIcon, Indicator } from "@shared/ui";
...
.volume-indicator-wrap__indicator.indicator--trigger.success {
  background: #0ead61;
}

.volume-indicator-wrap__indicator.indicator--trigger.danger {
  background: #e2534b;
}
</style>
