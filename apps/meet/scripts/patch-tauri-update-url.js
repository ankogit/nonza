...
const path = "/api/v1/desktop-update/{{target}}/{{arch}}/{{current_version}}";
config.plugins.updater.endpoints = [baseUrl + path];
...
const result = spawnSync("npx", ["tauri", "build"], { stdio: "inherit", env: buildEnv, cwd: root });
